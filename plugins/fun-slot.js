...
🎰 | *RANURAS* | 🎰 
 ...
 ────────
🎰 |   *SLOTS*   | 🎰`
await conn.sendHydrated(m.chat, `${s}\n\n${end}`, wm, null, md, 'Dark Angel-𝙈𝘿', null, null, [
...
🎰 | *RANURAS* | 🎰 
 ...
 ────────
🎰 |   *SLOTS*   | 🎰`
await conn.sendHydrated(m.chat, `${ss}\n\n${end}`, wm, null, md, '🧚🏻‍♀️Dark Angel🪽', null, null, [
...
if (command == 'slot') {       
await conn.sendHydrated(m.chat, `*Elija en que apostará ${apuesta}*`, wm, null, md, '🧚🏻‍♀️Dark Angel🪽', null, null, [
