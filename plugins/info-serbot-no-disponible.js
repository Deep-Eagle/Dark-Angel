...
let text = `
*කාර්යයන් | කාර්යයන් #jadibot #bots #serbot #subbot #getcode. ඒවා | හි නොමැත තුළ ලබා ගත නොහැක* ${gt}`.trim()   
conn.reply(m.chat, text, m, {
contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, 
title: '🧚🏻‍♀️Dark Angel🪽 | ᴅᴇᴇᴘ ᴇᴀɢʟᴇ',
body: 'Super Bot WhatsApp',         
previewType: 1, thumbnail: fs.readFileSync("./media/menus/Menu3.jpg"),
sourceUrl: `${yt}`}}})  
  
  let info = `*#serbot නොමැති බැවින්, දැන් ඔබට *\n*#botemporal හෝ #bottemporal විධානය භාවිතා කර මෙම Bot අංකය ඔබේ කණ්ඩායමට තාවකාලිකව සම්බන්ධ කර ගත හැක.*
  `.trim()
